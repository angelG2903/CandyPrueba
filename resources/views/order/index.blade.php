...
@if(!empty($orders))
    <div id="formulario" class="row mb-5 d-flex justify-content-start">
        ...
        <div class="col-sm-12 col-lg-6 mt-4">
            <div class="card text-white" style="max-width: 30rem;">
                ...
                <div class="card-body text-black tarjeta-color-body">
                    ...
                    <p class="card-text mt-3">Relleno: {{ $order-> relleno }}</p>
            ...
            <div class="modal-dialog">
                ...
                <div class="modal-content " style="background: transparent;border: none;">
                    ...
                    <div class="modal-body color-modal br-modal-bot">
                        ...
                        <p>Hora de entrega: {{ Carbon\Carbon::parse($order-> horaEntrega)->isoFormat('h:mm A') }}</p>
                        <p>Precio: {{ $order-> precio }}</p>
                        <p>Anticipo: {{ $order-> anticipo }}</p>
                        <p>Restan: {{ ($order->precio) - ($order->anticipo)  }}</p>
